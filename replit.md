...
## Recent Changes
- **2025-10-28**: **CRITICAL FIX - Eliminated Speculation Language & Enforced Exact Point Values**: Strengthened prediction accuracy analysis prompt to eliminate ALL speculation words ("likely", "probably", "may have", "might have", "appears to", "could have", etc.) AND require exact point values for every factor. System prompt now enforces: "yellow card cost him 1 point" (not "cost him"), "no clean sheet cost him 4 points" (not "no clean sheet"), exact point differentials between predicted and actual. Temperature lowered to 0.1 for pure factual analysis. Added 10 banned words + 2 banned phrases for missing point values. Examples updated: "Cucurella scored 1 pt [90 mins: +2, 1YC: -1]. Chelsea conceded (no clean sheet cost him 4 points), and the yellow card cost him 1 point." Analysis now provides ONLY provable facts with exact numerical impacts from FPL data.
