...
## Recent Changes
- **2025-10-28**: **UI FIX - Plan Overview Card Layout**: Fixed poorly formatted Plan Overview cards by moving "With AI Plan" text from a badge component to footer text ("GW 10 • With AI Plan"). This eliminates layout overlap issues and improves mobile responsiveness.
